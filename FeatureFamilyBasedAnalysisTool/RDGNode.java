...
//	private HashMap<Feature, RDGNode> rdgReferences;
...
//		this.rdgReferences = new HashMap<Feature, RDGNode>();
	}
...
//		System.out.println("# features dependencies: " + featureDependencies.size());
...
//			System.out.println("#OxyPartialConfig: " + partialConfigurations.size());
...
//					
//					Collection <Feature> keys = dfe.getFeatureReliability().keySet();
//					Iterator<Feature> itKeys = keys.iterator(); 
//					while (itKeys.hasNext()) {
//						Feature f = itKeys.next();
//						System.out.println(f.getName() + " --> " + dfe.getFeatureReliability().get(f).doubleValue());
//						
//					}
				}	  
			}
...
//	public HashMap<Feature, RDGNode> getRdgReferences() {
//		return rdgReferences;
//	}
