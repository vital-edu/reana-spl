...
public class FDTMCStub {
	...
	private FDTMC createSituationFDTMC() {
		...
		fdtmcSituation.createTransition(s1, s2, "fPlsRte"); 
		fdtmcSituation.createTransition(s1, s5, "1-fPlsRte");
		...
		fdtmcSituation.createTransition(s5, s6, "fOxy");
		fdtmcSituation.createTransition(s5, s9, "1-fOxy");
		...
		fdtmcSituation.createTransition(s9, s10, "fTemp");
		fdtmcSituation.createTransition(s9, s13, "1-fTemp");
		...
		fdtmcSituation.createTransition(s13, s14, "fPos");
		fdtmcSituation.createTransition(s13, s17, "1-fPos");
	...
	private FDTMC createSqliteFDTMC() {
		...
		fdtmcSqlite.createTransition(s1, s2, "0.999"); 
		fdtmcSqlite.createTransition(s1, s0, "0.001");
		fdtmcSqlite.createTransition(s2, s3, "0.999");
		fdtmcSqlite.createTransition(s2, s0, "0.001");
	...
	private FDTMC createMemFDTMC() {
		...
		//Transitions creation
		fdtmcMem.createTransition(s1, s2, "0.999");
		fdtmcMem.createTransition(s1, s0, "0.001"); 
		fdtmcMem.createTransition(s2, s3, "0.999"); 
		fdtmcMem.createTransition(s2, s0, "0.001");
	...
	private FDTMC createFileFDTMC() {
		...
		//Transitions creation
		fdtmcFile.createTransition(s1, s2, "0.999");
		fdtmcFile.createTransition(s1, s0, "0.001");
		fdtmcFile.createTransition(s2, s3, "0.999");
		fdtmcFile.createTransition(s2, s0, "0.001");
		fdtmcFile.createTransition(s3, s4, "0.999");
		fdtmcFile.createTransition(s3, s0, "0.001");
	...
	private FDTMC createPulseRateFDTMC() {
		...
		//Transition
		fdtmcPulseRate.createTransition(s1, s2, "0.999");
		fdtmcPulseRate.createTransition(s1, s0, "0.001");
		fdtmcPulseRate.createTransition(s2, s3, "0.999");
		fdtmcPulseRate.createTransition(s2, s0, "0.001");
		fdtmcPulseRate.createTransition(s3, s4, "0.999");
		fdtmcPulseRate.createTransition(s3, s0, "0.001");
		fdtmcPulseRate.createTransition(s4, s5, "0.999");
		fdtmcPulseRate.createTransition(s4, s0, "0.001");
		fdtmcPulseRate.createTransition(s5, s6, "fSqlite");
		fdtmcPulseRate.createTransition(s5, s9, "1-fSqlite");
		...
		fdtmcPulseRate.createTransition(s9, s10, "fMem");
		fdtmcPulseRate.createTransition(s9, s13, "1-fMem");
		...
		fdtmcPulseRate.createTransition(s13, s14, "0.999");
		fdtmcPulseRate.createTransition(s13, s0, "0.001");
		fdtmcPulseRate.createTransition(s14, s15, "0.999");
		fdtmcPulseRate.createTransition(s14, s0, "0.001");
		fdtmcPulseRate.createTransition(s15, s16, "0.999");
		fdtmcPulseRate.createTransition(s15, s0, "0.001");
