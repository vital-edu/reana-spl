...
public class Main {
	...
	public static void main(String[] args) throws InvalidTagException, UnsupportedFragmentTypeException, DOMException, InvalidGuardException, InvalidNumberOfOperandsException, InvalidNodeClassException {
